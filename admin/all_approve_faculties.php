			...
			<div class="wrap-table100">
				<div class="table100">
					<table>
						...
						<?php 
							$sql="SELECT * FROM `fac_details` WHERE status='1'";
						...
						<tbody>
								<tr>
									...
									<td class="column1"><a href="disapprove_faculties.php?fac_id=<?php echo $row['id']; ?>&p_name=<?php echo $page_name; ?>"><button class="btn btn-warning">Disapprove</button></a></td>
								</tr>

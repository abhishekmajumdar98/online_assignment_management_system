			...
			<div class="wrap-table100">
				<div class="table100">
					<table>
						...
						<?php 
							$sql="SELECT * FROM `st_details` WHERE year='$yr' and status='1' and course='BBA(Hons)'";
							$result=mysqli_query($con,$sql);
							while ($row = mysqli_fetch_assoc($result)) {
						?>
						<tbody>
								<tr>
									<td class="column1"><?php echo "RICIS-BBA ".$row['id']?></td>
									...
									<td class="column1"><a href="disapprove_students.php?st_id=<?php echo $row['id']; ?>&p_name=<?php echo $page_name; ?>"><button class="btn btn-warning">Disapprove</button></a></td>
								</tr>

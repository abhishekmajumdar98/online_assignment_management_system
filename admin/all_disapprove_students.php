...
<html lang="en">
<head>
	<title> All Disapprove Students </title>
	<meta charset="UTF-8">
			...
			<div class="wrap-table100">
				<div class="table100">
					<table>
						...
						<?php 
							$sql="SELECT * FROM `st_details` WHERE status='0'";
						...
						<tbody>
								<tr>
									...
									<td class="column1"><a href="approve_students.php?st_id=<?php echo $row['id']; ?>&p_name=<?php echo $page_name; ?>"><button class="btn btn-success">Approve</button></a></td>
								</tr>

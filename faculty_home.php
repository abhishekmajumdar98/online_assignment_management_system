<?php
	...
	$email=$_SESSION['fac_user_name'];
	$sql="select * from fac_details where email='$email' and status='1'";
                                            ...
                                            <div class="table-responsive panel">
                                                <table class="table table-hover">
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-info"><b>Qualification</b></td>
										...
										<div id="General" class="tab-pane fade">
                                            <div class="table-responsive panel">
                                                <table class="table table-hover">
                                                    <tbody>
                                                            <tr>
                                                                <td class="text-info"><b>Faculty Id</b></td>
                                                                <td><?php echo "RICIS-Faculty ".$key['id'] ?></td>
                                                            </tr>
                                                            <tr>

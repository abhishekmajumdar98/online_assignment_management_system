<?php
	...
	$sql='SELECT password from `st_details` WHERE id='.$_SESSION['std_id'];
	...
	if(isset($_POST['submit']))
	{
		...
		{
			$sql= 'UPDATE `st_details` SET `password`="'.$new.'" WHERE id='.$_SESSION['std_id'];
...
<html>
<head>
	<title>Student | Edit | Password</title>
	<!-- Meta tag Keywords -->
